...
export function Preloader() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="preloader-marquee flex w-max items-center gap-16 whitespace-nowrap font-display font-semibold text-5xl tracking-tight text-black/60 sm:text-7xl">
